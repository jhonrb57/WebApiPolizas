...
namespace DataObjects
{
    ...
    {
        public List<Poliza> Listar(Conexion conexionBd)
        {
        ...
        public Poliza Obtener(Conexion conexionBd, int numeroPoliza)
        {
        ...
        public bool Registrar(Conexion conexionBd, Poliza poliza)
        {
            using (SqlConnection context = new SqlConnection(conexionBd.ConexionBd()))
            {
        ...
        public bool Modificar(Conexion conexionBd, Poliza poliza)
        {
            using (SqlConnection context = new SqlConnection(conexionBd.ConexionBd()))
            {
        ...
        public bool Eliminar(Conexion conexionBd, int id)
        {
            using (SqlConnection context = new SqlConnection(conexionBd.ConexionBd()))
            {
